...
ap2_d3_gen_fr_fr = np.genfromtxt('./data/ap2_disp3_gen_inst_fr_fr.csv',
                                 delimiter=',')
axs0.plot(ap2_d2_gen_fr_t, ap2_d2_gen_fr_fr, marker='.', linestyle='None',
          color='0.5')
axs0.plot(ap2_d3_gen_fr_t, ap2_d3_gen_fr_fr, marker='.', linestyle='None',
          color='0')
axs0.set_xlim(0, 2)
axs0.set_ylim(0, 200)
axs0.set_xlabel('Time (sec)')
...
ap2_d3_nr_fr_fr = np.genfromtxt('./data/ap2_disp3_nr_inst_fr_fr.csv',
                                delimiter=',')
axs1.plot(ap2_d2_nr_fr_t, ap2_d2_nr_fr_fr, marker='.', linestyle='None',
          color='0.5')
axs1.plot(ap2_d3_nr_fr_t, ap2_d3_nr_fr_fr, marker='.', linestyle='None',
          color='0')
axs1.set_xlim(0, 2)
axs1.set_ylim(0, 200)
axs1.set_xlabel('Time (sec)')
...
ap3_d3_gen_fr_fr = np.genfromtxt('./data/ap3_disp3_gen_inst_fr_fr.csv',
                                 delimiter=',')
axs0.plot(ap3_d2_gen_fr_t, ap3_d2_gen_fr_fr, marker='.', linestyle='None',
          color='0.5')
axs0.plot(ap3_d3_gen_fr_t, ap3_d3_gen_fr_fr, marker='.', linestyle='None',
          color='0')
axs0.set_xlim(0, 2)
axs0.set_ylim(0, 200)
axs0.set_xlabel('Time (sec)')
...
ap3_d3_nr_fr_fr = np.genfromtxt('./data/ap3_disp3_nr_inst_fr_fr.csv',
                                delimiter=',')
axs1.plot(ap3_d2_nr_fr_t, ap3_d2_nr_fr_fr, marker='.', linestyle='None',
          color='0.5')
axs1.plot(ap3_d3_nr_fr_t, ap3_d3_nr_fr_fr, marker='.', linestyle='None',
          color='0')
axs1.set_xlim(0, 2)
axs1.set_ylim(0, 200)
axs1.set_xlabel('Time (sec)')
